...
async function sendShippedEmail(orderId: string, orderData: any, cartItems: any[]) {
              ...
              <table width="650" style="${STYLES.container}" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td style="padding:22px 24px;font-size:14px;color:#334b59;line-height:20px;">
                    ...
                    Your order on <a href="http://logi-ace.com" style="font-weight:700;color:${STYLES.linkBlue};text-decoration:none;">www.logi-ace.com</a> has been shipped. You can find below Tracking information and Return Label for your order.<br><br>
                  </td>
                </tr>
  ...
  const subject = `Order Shipped (#${orderId}) | Logi-ACE (CDW)${oemBrackets ? ' ' + oemBrackets : ''}`;
