...
function DashboardContent() {
    ...
    const powerBiUrl = "https://app.powerbi.com/view?r=eyJrIjoiMTQwZDhiMGEtZjQxMy00MzFkLWFmMGYtYmMzMTc0OWRlMGEzIiwidCI6ImY2MzFmNGVmLWMzYmItNDU5OC04NWZmLTM2OTNlNzZmMmZmYiIsImMiOjZ9"
